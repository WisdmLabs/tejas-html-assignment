  ...
  render() {
    ...
    return (
      <PluginSidebar
        name="wdm_sidebar"
        icon="share"
        title={__("Custom Sidebar", "wdm-plugins")}
      >
        <PanelBody title={__("Opengraph Options", "wdm-plugins")}>
          <TextControl
            label={__("Title", "wdm-plugins")}
            value={og_title}
            onChange={(og_title) => {
              editPost({
                meta: {
          ...
          />
          <TextareaControl
            label={__("Description", "wdm-plugins")}
          ...
          />
          <ToggleControl
            label={__("Override Featured Image", "wdm-plugins")}
